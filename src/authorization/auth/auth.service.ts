...
import { UserClass } from 'src/entities/user.entity';
...
export default class AuthService {
  ...
  private async validate(userData: UserClass): Promise<UserClass> {
  ...
  public async validateUser(
    ...
    const user = (await this.usersRepository.getVerifiedUserByEmail(
      email,
    )) as UserDocument;
